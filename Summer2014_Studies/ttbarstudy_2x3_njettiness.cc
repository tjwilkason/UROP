...
int main(int argc, char* argv[]){
    ...
    while (inputStream >> particle_number >> px >> py >> pz >> E >> particle_code){
      ...
      if (particle_number == 0) {
        ...
        for (unsigned int B = 0; B < betalist.size(); B++) {
          ...
          vector<PseudoJet> final_manual_axes_improved;
          ...
          while (njettiness <= 20) {
            ...
            if (triplet_counter >= 2 || njettiness == 20) {
              ...
              Selector hard_selector = SelectorNHardest(2);
              final_bigjets = hard_selector(tripledJets);

              for (int i_jet = 0; i_jet < final_bigjets.size(); i_jet++) {

                if (final_bigjets[i_jet].constituents().size() > 2) {

                  ClusterSequence clustSeq_subjet(final_bigjets[i_jet].constituents(), *jetDef);
                  vector<PseudoJet> subjet_axes3 = clustSeq_subjet.exclusive_jets(3);
                  vector<PseudoJet> subjet_axes2 = clustSeq_subjet.exclusive_jets(2);
                  ...
                  if (final_bigjets[i_jet].m() > 160 && final_bigjets[i_jet].m() < 240 && njettiness < 9) {
                    if (i_sample == 0) {
                      TH1* tau32_ttbar_manual = (TH1*)tau32_ttbar_manual_hists.At(B);
                      tau32_ttbar_manual->Fill((double)nsub3_manual.result(final_bigjets[i_jet])/nsub2_manual.result(final_bigjets[i_jet]));
                    }
                    if (i_sample == 1) {
                      TH1* tau32_dijets_manual = (TH1*)tau32_dijets_manual_hists.At(B);
                      tau32_dijets_manual->Fill((double)nsub3_manual.result(final_bigjets[i_jet])/nsub2_manual.result(final_bigjets[i_jet]));
                    }
                  }
                }
          ...
          njet_plugin_2.setAxes(clustSeq.exclusive_jets(2));
          ...
          JetDefinition *jetDef_2 = new JetDefinition(antikt_algorithm, initial_bigradius, recombScheme_akt, strategy_akt);
          ...
          for (int i_bigjet = 0; i_bigjet < jets_2.size(); i_bigjet++) {
            ...
            while (njettiness_2 <= 10) {

              int initial_axes_num = njettiness_2;
              ...
              // NjettinessPlugin njet_plugin_2times3_2(njettiness_2 - 1, axes_finder, measure_function);
              // JetDefinition njet_def_2times3_2(&njet_plugin_2times3_2);
              // njet_plugin_2times3_2.setAxes(clustSeq_2.exclusive_jets(njettiness_2 - 1));
              // ClusterSequence njet_cluster_2times3_2(jets_2[i_bigjet].constituents(), njet_def_2times3_2);
              // const NjettinessExtras *extras_2times3_2 = njettiness_extras(njet_cluster_2times3_2);
              // vector<PseudoJet> jets_2times3_2 = extras_2times3_2->jets();
              ...
              // if (!is_triplet[i_bigjet]) {
                if (triplet_counter >= 1 || njettiness_2 == 10) {
                  ...
                  for (int i_jet = 0; i_jet < final_bigjets_2.size(); i_jet++) {
                    ...
                    //   final_jets_2_improved_constituents.push_back(constituents[i_const]);
                    // }

                    if (final_bigjets_2[i_jet].constituents().size() > 2) {

                      ClusterSequence clustSeq_subjet(final_bigjets_2[i_jet].constituents(), *jetDef);
                      vector<PseudoJet> subjet_axes3 = clustSeq_subjet.exclusive_jets(3);
                      vector<PseudoJet> subjet_axes2 = clustSeq_subjet.exclusive_jets(2);
                      ...
                      if (final_bigjets_2[i_jet].m() > 160 && final_bigjets_2[i_jet].m() < 240 && njettiness_2 < 5 && min_mass_improved > 50) {
                        ...
                        if (i_sample == 1) {
                          ...
                          tau32_dijets_manual_2groups_improved->Fill((double)nsub3_manual.result(final_bigjets_2[i_jet])/nsub2_manual.result(final_bigjets_2[i_jet]));
                        }
                      }
                    }
                  ...
                  if (i_sample == 0) {
                    ...
                    max_njet_ttbar_manual_2groups_improved->Fill(njettiness_2);
                  }
                  if (i_sample == 1) {
                    TH1* max_njet_dijets_manual_2groups_improved = (TH1*)max_njet_dijets_manual_2groups_improved_hists.At(B);
                    max_njet_dijets_manual_2groups_improved->Fill(njettiness_2);
                  }
                  // final_manual_axes = min_manual_axes;
  ...
  for (int B = 0; B < betalist.size(); B++) {
    ...
    leg_ROC->Draw();
    ROC_compare->Write();
    ROC_compare->Print("ttbarstudy_bigjettest_plots/ttbarstudy_ROC_compare_pt" + (TString)ss_pt.str() + "_beta" + (TString)ss.str() + ".eps", "eps");
  ...
  mass_ttbar_compare->Print("ttbarstudy_bigjettest_plots/ttbarstudy_ttbar_mass_compare_pt" + (TString)ss_pt.str() + ".eps", "eps");
  ...
  mass_ttbar_compare_2jets->Print("ttbarstudy_bigjettest_plots/ttbarstudy_ttbar_mass_2jets_compare_pt" + (TString)ss_pt.str() + ".eps", "eps");
  ...
  mass_dijets_compare->Print("ttbarstudy_bigjettest_plots/ttbarstudy_dijets_mass_compare_pt" + (TString)ss_pt.str() + ".eps", "eps");
  ...
  mass_dijets_compare_2jets->Print("ttbarstudy_bigjettest_plots/ttbarstudy_dijets_mass_2jets_compare_pt" + (TString)ss_pt.str() + ".eps", "eps");
  ...
  area_ttbar_compare->Print("ttbarstudy_bigjettest_plots/ttbarstudy_ttbar_area_compare_pt" + (TString)ss_pt.str() + ".eps", "eps");
  ...
  area_dijets_compare->Print("ttbarstudy_bigjettest_plots/ttbarstudy_dijets_area_compare_pt" + (TString)ss_pt.str() + ".eps", "eps");
  ...
  rawmass_ttbar_compare->Print("ttbarstudy_bigjettest_plots/ttbarstudy_ttbar_rawmass_compare_pt" + (TString)ss_pt.str() + ".eps", "eps");
  ...
  qcd_efficiency_rawmass[1][i_pt] = mass_dijets_antikt_6jets->Integral((double)160/500*mass_dijets_antikt_6jets->GetNbinsX(), (double)240/500*mass_dijets_antikt_6jets->GetNbinsX());
    ...
    rawmass_dijets_compare->Print("ttbarstudy_bigjettest_plots/ttbarstudy_dijets_rawmass_compare_pt" + (TString)ss_pt.str() + ".eps", "eps");
    ...
    mass_2groups_ttbar_compare->Print("ttbarstudy_bigjettest_plots/ttbarstudy_ttbar_mass_2groups_compare_pt" + (TString)ss_pt.str() + ".eps", "eps");
    ...
    mass_2groups_improved_ttbar_compare->Print("ttbarstudy_bigjettest_plots/ttbarstudy_ttbar_mass_2groups_improved_compare_pt" + (TString)ss_pt.str() + ".eps", "eps");
    ...
    minmass_2groups_ttbar_compare->Print("ttbarstudy_bigjettest_plots/ttbarstudy_ttbar_minmass_2groups_compare_pt" + (TString)ss_pt.str() + ".eps", "eps");
    ...
    mass_2groups_improved_Wmasscut_dijets_compare->Print("ttbarstudy_bigjettest_plots/ttbarstudy_dijets_mass_2groups_improved_Wmasscut_compare_pt" + (TString)ss_pt.str() + ".eps", "eps");
      ...
      max_njet_ttbar_compare->Print("ttbarstudy_bigjettest_plots/ttbarstudy_ttbar_max_njet_compare_pt" + (TString)ss_pt.str() + ".eps", "eps");
      ...
      max_njet_dijets_compare->Print("ttbarstudy_bigjettest_plots/ttbarstudy_dijets_max_njet_compare_pt" + (TString)ss_pt.str() + ".eps", "eps");
      ...
      max_njet_ttbar_2groups_improved_compare->Print("ttbarstudy_bigjettest_plots/ttbarstudy_ttbar_max_njet_2groups_improved_compare_pt" + (TString)ss_pt.str() + ".eps", "eps");
      ...
      max_njet_dijets_2groups_improved_compare->Print("ttbarstudy_bigjettest_plots/ttbarstudy_dijets_max_njet_2groups_improved_compare_pt" + (TString)ss_pt.str() + ".eps", "eps");
  ...
  // delete mass_ttbar_compare;
    ...
    for (int B = 0; B < betalist.size(); B++) {
      ...
      // ROC_compare_total->Print("ttbarstudy_bigjettest_plots/ttbarstudy_ROC_compare_totalpt_beta" + (TString)ss.str() + ".eps", "eps");
    }
    ...
    ROC_compare_total_big->Print("ttbarstudy_bigjettest_plots/ttbarstudy_ROC_compare_totalpt_big.eps", "eps");
...
// top_efficiency_rawmass_biggraph->GetYaxis()->SetTitleOffset(1.3);
    ...
    top_rawmass_can->Print("ttbarstudy_bigjettest_plots/top_efficiency_rawmass.eps", "eps");
...
// top_efficiency_mass_biggraph->GetYaxis()->SetTitleOffset(1.3);
    top_mass_can->Write();
    top_mass_can->Print("ttbarstudy_bigjettest_plots/top_efficiency_mass.eps", "eps");
...
// top_efficiency_mass_2groups_biggraph->GetYaxis()->SetTitleOffset(1.3);
    ...
    top_mass_2groups_can->Print("ttbarstudy_bigjettest_plots/top_efficiency_mass_2groups.eps", "eps");
...
// top_efficiency_mass_2groups_improved_Wmasscut_biggraph->GetYaxis()->SetTitleOffset(1.3);
    ...
    top_ratio_can->Write();
    top_ratio_can->Print("ttbarstudy_bigjettest_plots/top_efficiency_ratio.eps", "eps");
...
// qcd_efficiency_rawmass_biggraph->GetYaxis()->SetTitleOffset(1.3);
    ...
    qcd_rawmass_can->Print("ttbarstudy_bigjettest_plots/qcd_efficiency_rawmass.eps", "eps");
...
// qcd_efficiency_mass_biggraph->GetYaxis()->SetTitleOffset(1.3);
    qcd_mass_can->Write();
    qcd_mass_can->Print("ttbarstudy_bigjettest_plots/qcd_efficiency_mass.eps", "eps");
...
// qcd_efficiency_mass_2groups_biggraph->GetYaxis()->SetTitleOffset(1.3);
    ...
    qcd_mass_2groups_can->Print("ttbarstudy_bigjettest_plots/qcd_efficiency_mass_2groups.eps", "eps");
...
// qcd_efficiency_mass_2groups_improved_Wmasscut_biggraph->GetYaxis()->SetTitleOffset(1.3);
    ...
    qcd_ratio_can->Write();
    qcd_ratio_can->Print("ttbarstudy_bigjettest_plots/qcd_efficiency_ratio.eps", "eps");
